// correccion de error me sale este comentario para que se quite.
/* eslint-disable react/prop-types */
import './Products.css'
//comente esta linea de codigo porque fue la que use para el ejemplo de props estructurado. const Products = (props) => {
...
return(
    ...
    {/* Agregando las propiedades directamente al componente, pero no se modifican las propiedades al importar el Componente en App.jsx, es decir, se repite la misma información
        ...
        */}
        ...
        {/**Props estructurados: puedo asignar diferentes propiedades a un div, sin tener que generar muchos props, solamente usando lla palabra reservada `props` como parámetro de la función.
